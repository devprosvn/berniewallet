...
class WalletRepository {
  ...
  Future<List<TransactionModel>> getTransactionHistory(String address,
      {int limit = kDefaultTransactionFetchLimit}) async {
    return _algorandService.getTransactionHistory(address);
  }
